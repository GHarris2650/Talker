...
?>
      ...
      <form name="formMessaging" action="messaging.ctrl.php" method="post" novalidate>
        <div class="form-group">
          <label for="formMessagingRecipient">Recipient</label>
            <select class="form-control <?php if ($_SESSION['msgid']!='301' && $_SESSION['msgid']!='') { echo 'is-valid'; }else{ echo (phpShowInputFeedback($_SESSION['msgid'])[0]); } ?>" id="formMessagingRecipient" name="formMessagingRecipient"
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <tr><td class="table-secondary"><?php echo $dbMessageRow["message_content"]; ?></td></tr>
      <?php } ?>
